    ...
    void addnewproduct(){
        ...
        if (parse) {
            if (productname.length() == 0 || category.length() == 0 || parsedPrice == 0) {
               ...
               // String name, double startpreis, String Uname, String kategorie, int dauer, String beschreibung


                if (as.produktAnlegen(productname, parsedPrice, name, category, 10, detail)) {
